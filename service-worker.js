...
const CACHE='avc-campaign1-v0.3.5';
const ASSETS=['./','./index.html','./adrian-visual-system.js','./adrian-achievements.js','./lessons.js','./keys.js','./error-coach.js','./app.js','./campaign-01.json','./manifest.webmanifest','./icon.svg'];
